...
//Declarar un arreglo de solo numeros
//Declarar un arreglo vacio para guardar el valor comparado
// 
    let count = 0 
    const highNum = [1,4,3,2,5]
    highNum.forEach(currentElement => {
        
            if(currentElement > count){
                count = currentElement
            /* high.push(currentElement) */
            }         
